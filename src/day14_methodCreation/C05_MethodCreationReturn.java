...
public class C05_MethodCreationReturn {
    public static void main(String[] args) {
        ...
        programin geri kalaninda bu yeni degeri kullanma imkanimiz olur.
         */
        ...
        //Sehir ismini programimizda buyuk harf olarak tarihi ise 2022-06-30 seklinde kullanmak istiyoruz.
    ...
    public static String tarihAl() {
        ...
        if(gun<=0 || gun>31){
            System.out.println("gun no 1-31 arasinda bir sayi olmalidir.");
        }else if(gun<=10 ){
            tarih=tarih+"0"+gun;
        }else{
            tarih=tarih+gun;
