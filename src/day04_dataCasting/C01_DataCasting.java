...
public class C01_DataCasting {
    public static void main(String[] args) {
        char harf='a';
        char yeniHarf=(char)(harf+1); //char yeniHarf=harf+1 kod bu durumda once sagdaki islemi yapar
        ...
        (data kayiplarinin olabilecegi veya datanin baskalasabilecegini) gorurse
