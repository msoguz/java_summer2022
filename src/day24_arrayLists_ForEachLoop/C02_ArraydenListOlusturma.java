...
public class C02_ArraydenListOlusturma {
    public static void main(String[] args) {
        ...
        while (!bildiMi){//bildiMi==false boyle de yazilir. Ama bu yazim profesyonel degil.

            System.out.println("Lutfen bir sayi tahmininde bulunun ");
            sayi= scan.nextInt();
            if(sayiListesi.contains(sayi)){
                System.out.println("Tebrikler " + tahminSayisi + " adet tahminde lsteden bir sayi buldunuz");
                bildiMi=true;
            }else{
                System.out.println(tahminSayisi + " Adet sayi sayi soylediniz ama hic biri listede yok");
                tahminSayisi++;
