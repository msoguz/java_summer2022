...
public class C01_indexOf {
    ...
    //eger istedigim index'ten sonrasini kontrol etmek istersek o zaman ayni methodu 2 parametreli olarak kullanabiliriz.

        System.out.println(str.indexOf("g",6)); //6 --> yazilan index'ten baslar.

        // yukaridaki str.daki 2. ve 3. e'nin indexlerini bulunuz.
